...
html.Div([
    DashIconify(icon="carbon:earth-filled", width=24, height=24, color=COLORS["accent"]),
    html.H5("Broader Impact", className="ml-2 mb-0")
], className="d-flex align-items-center mb-3"),

html.Div([
    dcc.Markdown("""
Wildfires continue to threaten California’s ecosystems, communities, and economy with increasing intensity. This project aims to support smarter, data-driven decision-making by improving not just the prediction of wildfire occurrence — but also the understanding of how severe a fire might become.

By identifying the environmental and socio-economic drivers of wildfire severity, this work can benefit:

- Fire management agencies by helping them prioritize where and when to deploy resources  
- Policy makers and planners by informing preventive strategies that reduce risk across vulnerable landscapes  
- Researchers by contributing insights to the broader study of climate change, land use, and urban-wildland interactions

This project strives to help reduce wildfire damage, protect residents, and create a safer, less dangerous California.
""", style={"color": COLORS["text"], "fontSize": "1.05rem", "lineHeight": "1.6"})
], className="p-4 rounded", style={
    "backgroundColor": COLORS["light_accent"],
    "border": f"1px solid {COLORS['secondary']}"
}),
