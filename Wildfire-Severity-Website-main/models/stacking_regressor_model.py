...
def update_image(selected):
    if selected == "hist":
            ...
            html.Div([
                html.Div([
                    ...
                    html.Div([
                        ...
                        ], style={"fontSize": "30px", "lineHeight": "1.6", "margin": "0"})
                    ], className="d-flex align-items-start mb-3"),
                    
                    html.Div([
                        html.P([
                            "In this case, we use ", html.Strong("Log(1 + x)"), " transformation which accomplishes many tasks:"
                        ], style={"fontSize": "30px", "lineHeight": "1.6", "marginBottom": "10px"}),
                ...
                html.Div([
                    ...
                    html.Div([
                        html.Div([
                            ...
                            html.Div([
                                html.Span("3.24", style={"fontSize": "30px", "fontWeight": "700", "color": "#D05F33"}),
                            ], className="mb-2"),
                            html.Ul([
        ...
        return (
            ...
            html.Div([
                html.Div([
                    html.H4("Scatter Plot Analysis", className="mb-3", style={"color": "#D05F33", "fontWeight": "600", "fontSize": "30px"}),
                    html.Div([
                        html.Span("🔍", style={"fontSize": "1.5rem", "marginRight": "10px"}),
                        html.Div([
                            html.H5("Predicted vs. Actual Values (Log Scale)", className="mb-2", style={"fontWeight": "600", "fontSize": "28px"}),
                            html.P([
