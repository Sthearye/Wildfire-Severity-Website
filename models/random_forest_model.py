...
def run_random_forest_model():
    ...
    y = np.log1p(df["incident_acres_burned"])  # Log-transform target
    ...
    sns.barplot(x=importances[:15], y=importances.index[:15], palette="YlOrRd")
    ...
    return html.Div([
        html.H3("🌲 Random Forest Wildfire Severity Prediction"),
